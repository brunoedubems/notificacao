package br.com.brunoedubems.notificacao.business;

import br.com.brunoedubems.notificacao.business.dto.TarefasDTO;
import br.com.brunoedubems.notificacao.infrastructure.exceptions.EmailException;
...
public class EmailService {
    ...
    public void enviaEmail(TarefasDTO dto) {
        ...
        try {
            ...
            mimeMessageHelper.setSubject("Assunto : Notificação de tarefa");

            Context context = new Context();
            context.setVariable("nomeTarefa", dto.getNomeTarefa());
            context.setVariable("dataEvento", dto.getDataEvento().format(DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm")));
